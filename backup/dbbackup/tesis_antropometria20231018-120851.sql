...
INSERT INTO `citas` VALUES (97,1,'2023-10-18'),(98,2,'2023-10-18');
...
INSERT INTO `informe_adulto` VALUES (35,174.45,91,21,12,15,8,28,37,39,16.9,96.3,98,104,97,1);
...
INSERT INTO `informe_atleta` VALUES (24,178.5,80,10,15,143,11.5,10.5,9.1,5,15,7.5,13,20.25,11.25,34.6,37.5,17.4,83.4,25,99.4,55.6,99,42.3,35,35,35,35,54,37,22.4,34.45,25.3,20.3,100.35,93.05,44.9,45,40.5,38,28,27.6,27.45,18,7.4,10,98,2);
...
) ENGINE=InnoDB AUTO_INCREMENT=99 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `paciente` VALUES (97,'Johnny Vargas','CI-11111111','Masculino','Afghanistan','1983-05-11','Beisbol','johnnyvargas@gmail.com','el parque'),(98,'Juan Perez','CI-1324567','Masculino','Venezuela','1983-04-05','Judo','juanperez@gmail.com','mikasa');
...
-- Dump completed on 2023-10-18 12:08:51
